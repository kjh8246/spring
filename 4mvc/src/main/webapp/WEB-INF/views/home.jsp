...
<hr>
<a href="./">현재 프로제트 경로(컨텍스트ㅜ)의 url은 http://localhost:8085/app/</a><br>
...
<h5>파라미터 테스트</h5>
<a href="search?name=모모&age=23">http://localhost:8085/app/search?name=홍길동&age=23</a><br>
...
http://localhost:8085/app/map?idx=23&cnt=44&title=momo&page=11</a>
<h5>Model 객체 테스트</h5>
<a href="model">http://localhost:8085/app/model</a><br>
<a href="redirect">http://localhost:8085/app/redirect</a>
