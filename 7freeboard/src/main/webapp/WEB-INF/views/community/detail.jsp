...
<hr>
 <table style="width:750px;margin:auto;">
 	...
 	<tr><td class="td1">내용</td>
 		...
 		<div  style="height: 300px;box-sizing: borderbox;"  id="cont">
 		<pre>${bean.content }</pre>
 		</div>
 		</td>   
...
<!-- 댓글 시작 -->
 ...
 <input type="hidden" name="ip" value="${pageContext.request.remoteAddr}">  <!-- 메인글의 idx -->
 <input type="hidden" name="pageNo" value="${page }">
				...
				<div id="comment">
					<div>
						...
						<!-- comment?idx=${cmt.idx}&pageNo=${page}&mref=${bean.idx} -->
							<a href="javascript:delete_cmt('${cmt}')"><img alt="삭제" src="${image}/delete.png" style="width:20px;"></a>
						</span>
					</div>
				</div>
