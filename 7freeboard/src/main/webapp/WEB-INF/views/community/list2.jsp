...
<div style="margin:auto;">
 <table>
	...
	<tr>
 	...
 	<a class="button" href="${pageContext.request.contextPath }">홈</a></td> <!-- href = http://localhost:8085/idev/ -->
...
<div style="text-align: center;">
	<!-- 가장 첫페이지로 이동 --><!-- href대신에 onclick 으로 변경해서 자바스크립트에서 처리합니다. -->
	...
	<a class="pagenum"onclick="javascript:goPage('${page.totalPage }')">&gt;&gt;</a>	<!-- 맨 마지막페이지 -->
</div>
